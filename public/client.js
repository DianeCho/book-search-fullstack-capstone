...
function buildBookReview(result) {
    ...
    for (let e = 0; e < result.length; e++) {
        if (result[e].title !== undefined) {
            ...
            if (currentBook !== oldBook) {
                ...
                bookHtml += '<img src="images/recipe.jpg" ' + result[e].image_url + 'class="books" alt="">';
